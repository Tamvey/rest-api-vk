...
public class PostController {
    ...
    public ResponseEntity<List> getAll(@RequestBody(required = false) Post body,
        ...
        URI uri = new URI("https", authority, "/posts",
    ...
    public ResponseEntity<Post> getOne(@PathVariable("id") int id,
                                       HttpServletRequest request)
            throws URISyntaxException {
        URI uri = new URI("https", authority, "/posts/" + id,
                request.getQueryString(), null);
        return new ResponseEntity<>(new RestTemplate().getForObject(uri, Post.class), HttpStatus.OK);
    }

    @PostMapping("/api/posts")
    public ResponseEntity<?> newPost(@RequestBody Post body,
    ...
    @PutMapping("/api/posts/{id}")
        public ResponseEntity<?> updatePost(@RequestBody Post body,
    ...
    public ResponseEntity<?> deletePost(@RequestBody(required = false) Post body,
                                        @PathVariable("id") int id,
                                        HttpMethod method,
                                        HttpServletRequest request) throws URISyntaxException {
        URI uri = new URI("https", authority, "/posts/" + id,
